...
检测完成后，将该内容翻译成另外两种语言，并分别为每种语言提供一个例句**如果是德语例句，使用过去式或现在完成时**，例句后附上中文翻译。
...
`,
    ...
    {
        label: "短文：中译德",
        content: "请将单引号中的中文短文翻译成德语，翻译水平应为A1-B1，避免使用生僻词汇，使用现在完成时。 在每句中文下面一行附上对应的德语句子。请严格按照输出指令来输出。",
   ...
   - 推荐2-3个同词族的高频词（如动词名词化形式）`,
    ...
    },
    {
        ...
        1. 词汇方面：
            ...
            提供难度在 A2-B1 级别的德语例句（使用现在完成时态），展示该词汇在不同语境下的用法，并附上中文翻译。
        2. 固定搭配方面：
            解释句子中使用的固定搭配或习语，说明其含义和用法。
            提供难度在 A2-B1 级别的德语例句（使用现在完成时态），展示该搭配在不同语境下的用法，并附上中文翻译。
        3. 语法方面：
